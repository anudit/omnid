...
contract OmnidTest is DSTest {
    ...
    function testUpdateSkin() public {
        ...
        omnid.updateSkin(0, 1);

        (uint256 score, uint256 refreshTime, uint256 skinIndex, bytes32 etching) = omnid.getIdDetails(owner);

        assertEq(skinIndex, 1);

    }

    function testUpdateForwarder() public {
        omnid.setTrustedForwarder(0x9399BB24DBB5C4b782C70c2969F58716Ebbd6a3b);
        assertEq(omnid.trustedForwarder(), 0x9399BB24DBB5C4b782C70c2969F58716Ebbd6a3b);
    }
